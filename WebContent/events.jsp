...
$.ajax({
  ...
  <h1> Risultati della ricerca</h1>
    ...
    <div class="container">
			<div class="row">
				<div class=col-md-3>
						<img src="content/lp.jpg" width="260" height="350">
						<br><br><br>
				<div class=jumbotron>Concerto Linkin Park
				</div>
				</div>
				<div class=col-md-3>
				<img src="content/stadium.jpg" width="260" height="350">
				<br><br><br>
			<div class=jumbotron>Juventus - Inter
				</div>
				</div>
				<div class="col-md-3">
				<img src="content/civlWar.jpeg" width="260" height="350">
				<br><br><br>
			<div class=jumbotron>Captain America : Civil War
			</div>
				</div>
				<div class="col-md-3">
				<img src="content/gpMessico.jpg" width="260" height="350">
				<br><br><br>
