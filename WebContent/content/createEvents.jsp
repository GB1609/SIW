...
<script>
                                          var index=0;
                                            ...
                                            $("#part0").append('<div class="col-md-1 col-sm-1"></div>  <div class="col-md-3 col-sm-2">  <div class="form-group"> <label for="select'+index+'">Partecipanti:</label> <select id="select'+index+'" class="form-control"> <c:forEach items="${ allPartecipants}" var="bo"> <option>${bo}</option> </c:forEach></select></div></div> <div class="col-md-1 col-sm-1" id="buttonAddPart"> <label for="addPart"> Add: </label> <button class="btn btn-success" id="addPart"> + </button> </div> ');
                                            });
...
<script>
      var index2=0;
        ...
        $("#buttonAddTicket").remove();
              $("#farlocco").append('<div class="row" id="ticketsRow'+index2+'"> <div class="col-md-3 col-sm-2"><div class="form-group"><label for="tickets'+index2+'">Tipologia Biglietti:</label>  <input type="text" class="form-control" id="tickets'+index2+'"> </div> </div> <div class="col-md-2 col-sm-2"> <label for="costo'+index2+'">Costo Biglietti:</label> <input type="text" class="form-control" id="costo'+index2+'"></div> <div class="col-md-2 col-sm-2"> <label for="num'+index2+'">Numero Biglietti:</label>  <input type="text" class="form-control" id="num'+index2+'" ></div> <div class="col-md-1 col-sm-1" id="buttonAddTicket"> <label for="addTickets"> Add: </label>  <button class="btn btn-success" id="addTickets"> + </button> </div></div><br>');
                                              });
                                          </script>
...
<body>
	...
	<div class="container">
		...
		<div class="row" id="part0">
			...
			<div class="col-md-1 col-sm-1" id="buttonAddPart">
		...
		<div id="farlocco">
			<div class="row" id="ticketsRow0">
				...
				<div class="col-md-1 col-sm-1" id="buttonAddTicket">
