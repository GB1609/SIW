...
<script>
      var index2=0;
        ...
        $("#buttonAddTicket").remove();
              $("#farlocco").append('<div class="row" id="ticketsRow'+index2+'"> <div class="col-md-3 col-sm-2 col-xs-2"><div class="form-group"><label for="tickets'+index2+'">Tipologia Biglietti:</label>  <input type="text" class="form-control" id="tickets'+index2+'"> </div> </div> <div class="col-md-2 col-sm-2 col-xs-2"> <label for="costo'+index2+'">Costo Biglietti:</label> <input type="text" class="form-control" id="costo'+index2+'"></div> <div class="col-md-2 col-sm-2 col-xs-2"> <label for="num'+index2+'">Numero Biglietti:</label>  <input type="text" class="form-control" id="num'+index2+'" ></div> <div class="col-md-1 col-sm-1 col-xs-1" id="buttonAddTicket"> <label for="addTickets"> Add: </label>  <button class="btn btn-success" id="addTickets"> + </button> </div></div><br>');
                                              });
                                          </script>
