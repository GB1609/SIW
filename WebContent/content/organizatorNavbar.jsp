	...
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			...
			<a href="#" class="navbar-brand"> <img
				...
				src="<%=request.getContextPath()%>/assets/logoSIW.png" alt="SIW"
				width="60">
			</a>
		</div>
		<div class="collapse navbar-collapse" id="mainNavBar">
			<div class="nav navbar-nav navbar-left">
				<li><a href="<%=request.getContextPath()%>/content/home.jsp">Home</a>
				</li>
				<li><a
					href="<%=request.getContextPath()%>/SearchEvents?typeOfResearch=All"
					id="eventi">Eventi</a></li>

			</div>
			<ul class="nav navbar-nav  navbar-right">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown">Organizator<span class="caret"> </span>
				</a>
					<ul class="dropdown-menu">
						<li><a
							href="<%=request.getContextPath()%>/DataForOrganizatorServlet"
							id="organizza">Crea un evento</a></li>
						<li><a href="#">Gestisci eventi</a></li>
					</ul></li>
				<li>
					<form class="navbar-form" role="search"
						action="<%=request.getContextPath()%>/ParameterSearchEvents">
						<div class="form-group">
							<input type="text" id=inpid name="value" class="form-control"
				...
				<li><a href="home.jsp" id="logoutButton">Logout 
				</a></li>
			</ul>
		</div>
		<script
